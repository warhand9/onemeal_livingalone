...
public class CustomerAccount extends Account {
	...
	private ArrayList<Integer> personalIngredients = new ArrayList<Integer>();		///< 개인 식재료 목록
	private ArrayList<Integer> personalFavoriteFoods = new ArrayList<Integer>();			///< 관심 요리 목록
	private ArrayList<Integer> personalFoodReviews = new ArrayList<Integer>();		///< 요리 리뷰 목록
	...
	{}
	public void deletePersonalFavoriteFood()
	{}
	...
	/** 계정의 이메일 주소를 변경합니다. 
	 * 
	 * 새로운 이메일 주소는 checkEmailValidity() 를 통해, 유효성을 검사하게 됩니다.
	...
	public boolean equals(Object another) {
		return another instanceof CustomerAccount
